...
@pytest.mark.parametrize(
    ...
    [
        TestCase(
            ...
            expected_file_path_template="/g3/COMMONDATA/OPER/CEMC/MESO_1KM/Prod-grib/{start_time_label}/ORIG/"
                                        "rmf.hgra.{start_time_label}{forecast_hour_label}.grb2"
        ),
        TestCase(
            Query(data_type="cma_meso_1km/grib2/modelvar"),
            expected_file_path_template="/g3/COMMONDATA/OPER/CEMC/MESO_1KM/Prod-grib/{start_time_label}/MODELVAR/"
